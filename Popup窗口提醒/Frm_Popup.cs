        ...
        public void Show()
        {
            switch (this.InfoState)
            {
                case InformStyle.Vanish://窗体隐藏
                    ...
                    this.timer1.Interval = 20;//设置时间间隔为100
        ...
        private void timer1_Tick(object sender, System.EventArgs e)
        {
            switch (this.InfoState)
            {
                ...
                case InformStyle.Vanishing://隐藏当前窗体
                    ...
                    {
                        if (this.Top <= this.Rect.Bottom - 10)//如果窗体没有完全隐藏
                            this.SetBounds(Rect.X, this.Top + 10, Rect.Width, this.Height - 10);//使窗体不断下移
                        else
                        {
                            this.Hide();//隐藏当前窗体
